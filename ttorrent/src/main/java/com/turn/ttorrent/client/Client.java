...
public class Client extends Observable implements Runnable,
	...
	public synchronized void info() {
		...
		Log.e("Liu",this.getState().name()+"/"+this.torrent.getCompletedPieces().cardinality()+"/"+this.torrent.getAvailablePieces().cardinality()+"/"+
				this.connected.size()+"/"+String.format("%.2f", ul/1024.0));
